//
//  EchoSHKConfigurator.m
//  EnglishStudy
//
//  Created by Will Entriken on 8/6/12.
//
//

#import "EchoSHKConfigurator.h"

@implementation EchoSHKConfigurator
...
- (NSString*)readItLaterKey {
	return @"d11gduq1p3c64VO78aTb769QdkA0i189";
}

// Diigo - http://www.diigo.com/api_keys/new/
- (NSString*)diigoKey {
    return @"a195dc4da9ce4346";
}
...
- (NSString*)twitterConsumerKey {
	return @"4wQlo7hbDAmHcm0MbPicaQ";
}

- (NSString*)twitterSecret {
	return @"pQQzbcB8xyCxJqNX7KbshuWIYNNDHFRq8VYkMak";
}
...
- (NSString*)readabilitySecret {
	return @"FNu3mNCGv2d8QyRCN7PCfRZFGfQp2RFE";
}
