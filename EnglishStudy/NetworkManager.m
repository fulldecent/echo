         ...
         onFailure:(void(^)())failureBlock
{
    ...
    [JSONop setUploadProgressBlock:^(NSInteger bytesWritten, long long totalBytesWritten, long long totalBytesExpectedToWrite) {
        if (progressBlock)
            ...
            onSuccess:(void(^)())success onFailure:(void(^)(NSError *error))failure;
{
    ...
    UIImage *thumbnail = [FDTakeController imageWithImage:photo scaledToSizeWithSameAspectRatio:CGSizeMake(100, 100)];
